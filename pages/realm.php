...
<div class="body-body">
	<!-- BOX -->
	<div class="box">
		<div class="title">{online_rname} - <span>Top 10 Kills</span></div>
		<div class="body">
			<table width="100%">
				<tr>
					...
					<td align="center"><u>Total Kills</u></td>
	...
	<!-- BOX -->
	<div class="box">
		<div class="title">{login=Online players is currently under development.-}Caution - <span>Connection Required</span>{/login}</div>
		<div class="body">
			{login=
			<table width="100%">
				<tr>
